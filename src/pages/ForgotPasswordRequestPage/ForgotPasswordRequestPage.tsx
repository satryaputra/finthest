  ...
  return (
    <div>
      ...
      <div className="px-6 py-6 flex flex-col gap-2">
        ...
        <p className="text-secondary font-extralight">Jangan khawatir! kami akan mengirimkan kode ke email anda.</p>
        <div>
          <FormProvider {...metodth}>
            ...
            >
              <div>
                <Input name="email" label="Email" placeholder="Input your email" type="email" />
              </div>
